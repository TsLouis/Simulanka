...
This project is indexed by GitNexus as **Simulanka** (2042 symbols, 3002 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
