...
This project is indexed by GitNexus as **Simulanka** (1527 symbols, 2192 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
