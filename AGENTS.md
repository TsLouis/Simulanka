...
This project is indexed by GitNexus as **Simulanka** (2997 symbols, 4627 relationships, 64 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
