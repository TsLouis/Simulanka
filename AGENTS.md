...
This project is indexed by GitNexus as **Simulanka** (2787 symbols, 4301 relationships, 62 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
