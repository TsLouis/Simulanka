...
This project is indexed by GitNexus as **Simulanka** (1504 symbols, 2168 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
