...
This project is indexed by GitNexus as **Simulanka** (2205 symbols, 3216 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
