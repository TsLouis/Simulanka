...
This project is indexed by GitNexus as **Simulanka** (3401 symbols, 5166 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
