...
This project is indexed by GitNexus as **Simulanka** (3215 symbols, 4961 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
