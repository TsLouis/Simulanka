...
This project is indexed by GitNexus as **Simulanka** (3303 symbols, 5026 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
