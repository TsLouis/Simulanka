...
This project is indexed by GitNexus as **Simulanka** (3123 symbols, 4806 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
