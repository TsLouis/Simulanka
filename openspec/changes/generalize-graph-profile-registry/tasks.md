...
- [ ] 3.1 将 core containment/data_flow 与通用 capabilities 注册为 core package
- [ ] 3.2 将 filesystem、ml/torch、research、runtime 类型和 edge rules 分入可信内置包
- [ ] 3.3 将 Conv/Linear/运算等实例目录迁为 TemplateSpec，不扩大 Profile 数量
...
- [ ] 4.1 定义 ActionSpec、RefSet predicate、executor family、reason code 和 Affordance DTO
...
- [ ] 6.6 `openspec validate generalize-graph-profile-registry --strict` 通过并完成另一方交叉审查
